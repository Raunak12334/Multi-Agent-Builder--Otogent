...
import { User, Building2, Crown, BadgeCheck } from "lucide-react";
...
export default async function ProfileSettingsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 w-full">
      <div className="mb-8">
        <h1 className="text-3xl font-semibold tracking-tight font-display mb-2">Profile & Settings</h1>
        <p className="text-muted-foreground">Manage your personal information and view organizational status.</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="border rounded-2xl bg-white dark:bg-slate-900 shadow-sm overflow-hidden">
          ...
          <div className="p-6 grid gap-6 md:grid-cols-2">
            ...
            <div>
              <label className="text-sm text-muted-foreground mb-1 block">System Role</label>
        ...
        <div className="border rounded-2xl bg-white dark:bg-slate-900 shadow-sm overflow-hidden">
          ...
          <div className="p-6 grid gap-6 md:grid-cols-2">
            ...
            <div>
              <label className="text-sm text-muted-foreground mb-1 block">Primary Use Case</label>
              <div className="font-medium capitalize">{organization.useCase}</div>
            </div>
            ...
            <div className="md:col-span-2 pt-4 border-t mt-2">
              ...
              <div className="flex items-center justify-between p-4 border rounded-xl bg-slate-50 dark:bg-slate-950">
                <div className="flex items-center gap-4">
                  <div className={`h-12 w-12 rounded-full flex items-center justify-center ${isFree ? 'bg-slate-200 text-slate-600 dark:bg-slate-800 dark:text-slate-400' : 'bg-primary/20 text-primary'}`}>
                    <BadgeCheck className="h-6 w-6" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg">{organization.subscription?.plan || "UNKNOWN"} Plan</h3>
        ...
        <div className="border border-red-200 dark:border-red-900/50 rounded-2xl bg-white dark:bg-slate-900 shadow-sm overflow-hidden mt-8">
          <div className="p-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">End your current working session</p>
              </div>
              <SignOutButton />
           </div>
        </div>
